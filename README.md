...
- [pydantic-collab](https://github.com/boazkatzir/pydantic-collab/) - Multi-agent orchestration framework for building agent teams that collaborate via handoffs, consultations (tool calls), and shared memory. Features pre-built and custom network topologies and Logfire observability. 
